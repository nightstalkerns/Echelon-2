...
?>
    ...
    <div class="container my-2">
        ...
        <form action="actions/email-test.php" method="post" id="emailtestform">
        <input type="hidden" name="email-test" id="email-test" value="email-test" />
        <input type="hidden" name="email" value="<?php echo $mem->email; ?>" id="email"/>
        <div class="card">
            <div class="card-body">

                <!-- <h6 class="my-4">email test</h6> -->
                <div class="col justify-center">
                    <div class="form-group row">                
                        <label class="col-sm-4 col-form-label" for="emailtest">emailtest</label>
                        <button id="emailtest-button" class="btn btn-primary float-right my-2" value="Emailtest" type="submit">Email Test</button>
                    </div>
                </div>
            </div>
        </div>
